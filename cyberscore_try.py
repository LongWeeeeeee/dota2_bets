        ...
        for match in data['rows']:
            ...
            if result is not None:
                ...
                if result is not None:
                    ...
                    radaint_team_avg_kills, radiant_team_avg_time, radiant_lane_report, radiant_over45 = analyze_players(my_team = radiant_heroes_and_pos, enemy_team = dire_heroes_and_pos)
                    dire_team_avg_kills, dire_team_avg_time, dire_lane_report, dire_over45 = analyze_players(my_team = dire_heroes_and_pos, enemy_team = radiant_heroes_and_pos)
